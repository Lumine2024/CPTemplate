...
I have trimmed my competitive programming templates into two versions: one is markdown document(and the exported PDF from it); another is trimmed .cpp files, which can be pasted to contest field to directly form your solution below.

## Features
1. Excapsulated, suitable for convenient usage. For most of the bottom implementations I used wrapper functions(like use `query(l, r)` to wrap `_query(l, r, 0, 0, n)` in segment tree) to avoid unneccessary errors
...
However, if you have something that need me to implement, you can make an Issue to me

---

Finally, wish you can all have a nice trip on ICPC/OI!
